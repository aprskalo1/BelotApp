    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                mm.Body = $"Poštovani/a {user.UserName},<br><br>Primili smo Vaš zahtjev za ponovno postavljanje lozinke na Vašem računu. Kako biste postavili novu lozinku, molimo vas da kliknete na sljedeću poveznicu:<br><br><a href=\"{HtmlEncoder.Default.Encode(callbackUrl)}\">Postavi novu lozinku</a><br><br>Ako niste zatražili promjenu lozinke, možete zanemariti ovu poruku.<br><br>S poštovanjem,<br>Vaš BelotBlok.";
